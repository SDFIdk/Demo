...
VisStedet.Search.GeoSearch = VisStedet.Utils.Class (VisStedet.Search,{
     ...
     *          - 'Stednavne'
     */
    resources: ['Adresser','Matrikelnumre','Kommuner','Sogne','Opstillingskredse','Politikredse','Postdistrikter','Regioner','Retskredse','Stednavne'],
    ...
    initialize: function (options) {
        this.url = 'https://services.kortforsyningen.dk/Geosearch?service=GEO';
