findStedet_layers = [
{ layerid: 1, type: "WMTS", name: "Sk\u00E6rmkort", url: "https://services.kortforsyningen.dk/topo_skaermkort", params: { service: 'WMTS', version: '1.0.0',
...
{ layerid: 5, type: "WMTS", name: "Sk\u00E6rmkort d\u00E6mpet", url: "https://services.kortforsyningen.dk/topo_skaermkort_daempet", params: { service: 'WMTS', version: '1.0.0',
...
{ layerid: 2, type: "WMTS", name: "Flyfoto", url: "https://services.kortforsyningen.dk/orto_foraar", params: { service: 'WMTS', version: '1.0.0',
...
{ layerid: 4, type: "WMTS", name: "Hill shade", url: "https://services.kortforsyningen.dk/dhm", params: { service: 'WMTS', version: '1.0.0',
...
{ type: "WMS", name: "Matrikelkort", url: "https://services.kortforsyningen.dk/service", params: { service: 'WMS', Transparent: true, servicename: 'mat', layers: 'Centroide,MatrikelSkel,OptagetVej',
...
//{ type: "WMS", name: "Forvaltning beta", url: "https://services.kortforsyningen.dk/service", params: { service: 'WMS', Transparent: true, servicename: 'forvaltning_beta', layers: 'basis_ortofoto,basiskort,teknik,natur,brugsgraense,trafiksikkerhed,hoejspaendingsledning,matrikel',
